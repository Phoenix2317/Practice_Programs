...
Console.WriteLine($"Welcome to operand city! Your current location is: {startLoc.Row}, {startLoc.Column}");
Console.WriteLine("Let's head south first!");

startLoc = startLoc + Direction.South;

Console.WriteLine($"Now we are at: {startLoc.Row}, {startLoc.Column}");
